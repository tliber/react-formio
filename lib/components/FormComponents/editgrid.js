    ...
    _this3.elementChange = function (component) {
      if (component.props.component.key) {
        _this3.setState(function (previousState) {
          ...
          // sets the state of the edit on the page's submission object whenever a change occurs section
          _this3.props.editDone(previousState.value, _this3.props.rowIndex)
...
exports.default = _react2.default.createClass({
  ...
  getInitialValue: function getInitialValue() {
    // if value here buttons show but no form
    return [];
  },
  ...
  // this function saves the selected for to the form submission object
  ...
  getElements: function getElements() {
    ...
    // styling and functionality here
    return _react2.default.createElement(
      'div',
      ...
      _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          value.map(function (row, rowIndex) {
            ...
            // This is where the actual row component gets rendered
      ...
      // this is where button for adding new row get created
